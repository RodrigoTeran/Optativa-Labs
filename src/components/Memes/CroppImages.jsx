...
const CroppImages = ({
  ...
  const _crop = () => {
    setImageDestination(
      cropperRef.current.getCroppedCanvas().toDataURL("image/png")
    );
  };
  ...
  useEffect(() => {
    ...
    if (!firstScroll && srcImageYes) {
      window.scroll({
        top: getTop(".cropper-container-my"),
        left: 0,
        behavior: "smooth",
      });
      setFirstScroll(true);
    }
  }, [isResponse, srcImageYes]);

  return (
    <div
      className={`cropper-container-my ${srcImageYes ? "open" : ""}`}
      style={{
        ...
        {srcImageYes ? (
          <>
            <motion.div
              ...
              className="cropper-container-my-title"
            >
              Recorta la imagen
            </motion.div>
            <motion.div
              ...
              className="cropper-container-my-container-images"
            >
              <div>
                <Cropper
                  src={imageSrc}
            ...
            <motion.div
              ...
              className="cropper-container-my-container-buttons"
            >
